...
insert into produto values( 1 , 'NOTEBOOK',4 ,'123131','1251.29'  ,'A' );
insert into produto values( 2 , 'SMARTPHONE',5,'123223','1242.21'  ,'A' );
insert into produto values( 3 , 'DESKTOP' ,4,'1231','1241.21'  ,'A' );
insert into produto values( 4 , 'TELEVISÃO' ,5,'142123','2564.92'  ,'A' );
insert into produto values( 5 , 'DRONE' ,4,'7684','2325.32'  ,'A'  );
## Fim popula tabela Produtos
desc venda;
select * from venda;
## Inicio popula tabela Vendas  
insert into venda values(1    , '1'    , 1 , 4 , 1 ,  '25141.02'  , 0 , '25141.02'  ,  '2015-01-01' );
insert into venda values(2    , '2'    , 2 , 5 , 2 ,  '12476.58'  , 0 , '12476.58'  ,  '2015-01-02' );
insert into venda values(3    , '3'    , 3 , 4 , 1 ,  '16257.32'  , 0 , '16257.32'  ,  '2015-01-03' );
insert into venda values(4    , '4'    , 4 , 5 , 2 ,  '8704.55',    0 , '8704.55'   ,  '2015-01-04' );
insert into venda values(5    , '5'    , 5 , 4 , 1 ,  '13078.81', 0 , '13078.81'  ,  '2015-01-01' );
insert into venda values(6    , '6'    , 6 , 5 , 2 ,  '6079.19',    0 , '6079.19'   ,  '2015-01-02' );
insert into venda values(7    , '7'    , 7 , 4 , 1 ,  '7451.26',    0 , '7451.26'   ,  '2015-01-03' );
insert into venda values(8    , '8'    , 8 , 5 , 2 ,  '15380.47', 0 , '15380.47'  ,  '2015-01-04' );
insert into venda values(9    , '9'    , 9 , 4 , 1 ,  '13508.34', 0 , '13508.34'  ,  '2015-01-01' );
insert into venda values(10    , '10' , 1 , 5 , 2 ,  '20315.07', 0 , '20315.07'  ,  '2015-01-02' );
insert into venda values(11    , '11' , 1 , 4 , 1 ,  '8704.55',    0 , '8704.55'   ,  '2015-01-01' );
insert into venda values(12    , '12' , 2 , 5 , 2 ,  '11198.05', 0 , '11198.05'  ,  '2015-01-02' );
insert into venda values(13    , '13' , 3 , 4 , 1 ,  '4967.84',    0 , '4967.84'   ,  '2015-01-03' );
insert into venda values(14    , '14' , 3 , 5 , 2 ,  '7451.26',    0 , '7451.26'   ,  '2015-01-04' );
insert into venda values(15    , '15' , 5 , 4 , 1 ,  '10747.359', 0 , '10747.36'  ,  '2015-01-01' );
insert into venda values(16    , '16' , 6 , 5 , 2 ,  '13502.34', 0 , '13502.34'  ,  '2015-01-02' );
insert into venda values(17    , '17' , 7 , 4 , 1 ,  '22222.99', 0 , '22222.99'  ,  '2015-01-03' );
insert into venda values(18    , '18' , 8 , 5 , 2 ,  '15465.69', 0 , '15465.69'  ,  '2015-01-04' );
insert into venda values(19    , '19' , 9 , 4 , 1 ,  '4650.64',    0 , '4650.64'   ,  '2015-01-01' );
insert into venda values(20    , '20' , 9 , 5 , 2 ,  '6975.96',    0 , '6975.96'   ,  '2015-01-02' );
...
-- testes para deixar valores default

create table T2 (b blob default ('abc'), sigla_estado char(2));
desc t2;
select * from t2;
insert into t2 (sigla_estado) values ('PB');
alter table t2 add situacao boolean default true;
insert into t2 (situacao) values (false);
insert into t2 (b) values ('aoesss');
